            ...
            <div className='row'>
                <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                    <div className='m-2 py-5 text-center'>
                        <h1  className='text-white ' style={{fontSize:'2rem'}} >We Care for your Health Care and Timely Mediciens to Remind</h1>
                        <p className='text-white lead'>Medication App For Better and Healthy Socity.</p>
                        <a href='/sign-up' className='btn btn-outline-light px-5 py-2 text-btn rounded-pill my-3'>Know More</a>
                    </div>
                </div>
            ...
            <div className='login' style={{position:'relative', top:'-100px'}}>
                <div className='login_content p-5 shadow rounded-5'>
                    <div className='text-center pb-2'>
                        <h4 className='text-start text-white'>Login to Expolore Or Tool</h4>
                    </div>
